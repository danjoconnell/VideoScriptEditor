...
{
    /// <summary>
    /// Model encapsulating ellipse masking shape segment data.
    /// </summary>
    [Serializable()]
    [DataContract(Name = "Ellipse", Namespace = "")]
    public class EllipseMaskShapeModel : SegmentModelBase, IEquatable<EllipseMaskShapeModel>
    {
        /// <summary>
        ...
        {
            return Equals(obj as EllipseMaskShapeModel);
        }
        ...
        /// </remarks>
        public bool Equals([AllowNull] EllipseMaskShapeModel other)
        {
